...
class TheIAPlayerApp(KitApp):
    ...
    BINDINGS = [
        ...
        Binding("ctrl+up", "queue_move(-1)", show=False),
        Binding("ctrl+down", "queue_move(1)", show=False),
        ...
        Binding("v", "toggle_selection", show=False),
        Binding("S", "share", show=False),
    ...
    async def action_show_lyrics(self) -> None:
        ...
        lines = await self.client.get_lyrics(
            song.id,
            artist=song.artist,
            title=song.title,
            album=song.album,
