...
| Soporte Multi-Servidor (Profile Switcher) | `app.py`, `screens.py` | `ctrl+p` — Modal interactivo de cambio de servidor en caliente con reconexión de cliente Subsonic y flushing seguro de cola para evitar cruce de tracks. |
